...
2. 主要機能の箇条書き（⏳そろそろ切れるかも・⚡よく買うもの・📦ストック・🎯ミッション・💴支出の記録）
...
### 必須ドキュメント
- [x] **プライバシーポリシー**(両ストア必須・自前ホスティング必要) — `privacy.html` で公開済み
- [x] **利用規約**(任意だが推奨) — `terms.html` で公開済み
- [ ] **サポート連絡先**(メールアドレスでOK) — 現状は GitHub Issues のみ。ストア申請時は連絡用メールアドレスの用意を検討
