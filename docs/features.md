...
下のタブ（お買い物・ミッション・ストック・設定）は、ボタンをタップする以外に
**左右にスワイプ**しても切り替えられます。
...
設定タブの **⏳ そろそろ切れるかも → 知らせる時期** で、**何日前からお知らせするか**を選べます。
...
定番品を登録しておくと、**行をタップするだけでリストに追加**できます。カテゴリごとに並びます。

**登録の仕方は2つ**
1. パネル下の「＋ よく買うものを登録」から入力する
2. **買い物リストや履歴のカードにある ☆ をタップ**（メモ・予算・カテゴリごと登録されます。登録済みは⭐に変わります）

削除は「✏️ 編集」を押したときだけ出ます（誤操作防止）。
...
「＋ よく買うものを登録」からは、**買う間隔（任意）**も一緒に指定できます。品物によって
...
- **💴 金額** — 実際に払った金額を記録できます。記録すると設定タブの「今月のおかいもの」が**実支出の集計**に変わります
...
| ⏳ そろそろ切れるかも | 何日前からお知らせするか（家族で共通） |
| 🔔 通知 | サウンド / テーマ（端末に合わせる・ライト・ダーク）/ 買い物リマインドの時刻 |
| 📊 今月のおかいもの | 完了件数と支出（💴を記録していれば実支出、無ければ予算合計）＋その他の支出 |
| 🛡️ メンバー管理 | **保護者のみ** |
| 🔧 メンテナンス | 更新・復旧用 |
...
「今月のおかいもの」の集計に含められます。「📊 今月のおかいもの」カードの
**「＋ その他の支出を記録」**から。
...
| ⏳ の予告が早すぎる・遅すぎる | 設定 → ⏳そろそろ切れるかも → **知らせる時期**を変更 |
