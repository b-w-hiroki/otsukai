...
下部のフローティングボタン列にある **＋ 追加** から追加します。品名だけでOK、以下は任意です。
...
**登録の仕方は2つ**
1. 「⚡よく買う」シートの **＋ 新しく登録する**から入力する（写真も付けられます）
...
新しいバージョンが出ると画面上部に「🆕 新しいバージョンがあります」と出ます。
何か入力中だったり、シートを開いていたりしなければ、**しばらくすると自動で更新**されます。
急いでいるときは、バナーの「今すぐ更新」をタップすればすぐに切り替わります。
