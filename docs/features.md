...
5. [⚡ よく買うもの](#5--よく買うもの)
6. [💴 支出・家計](#6--支出家計)
7. [🧾 購入完了済み履歴](#7--購入完了済み履歴)
8. [🎯 ミッションタブ（ごほうび・ポイント）](#8--ミッションタブごほうびポイント)
9. [📦 ストックタブ](#9--ストックタブ)
10. [⚙️ 設定タブ](#10-️-設定タブ)
11. [🔔 通知](#11--通知)
12. [👨‍👩‍👧 役割とできること](#12--役割とできること)
13. [困ったときは](#13-困ったときは)
...
フローティングボタンとプレイヤー情報シートから開くシートです（[5章](#5--よく買うもの)・
[6章](#6--支出家計)）。ミッションもコア機能ではないため下部タブには置かず、
...
- **💴 金額** — 実際に払った金額を記録できます。記録すると「💴 支出・家計」（[6章](#6--支出家計)）の集計が**実支出の集計**に変わります
...
- 🟢 たっぷりある / 🟡 残り少ない / 🔴 切れてる
- 写真を付けて登録できます（どれのことか一目で分かる）。実際に撮る/選ぶ以外に、🎨「イラストから選ぶ」も使えます
...
**💴 支出・家計**は設定タブではなく、**プレイヤー情報シート**（左上のアバター）にあります（→ [6章](#6--支出家計)）。
