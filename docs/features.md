...
**カテゴリは🍎食品・🧻日用品・📦その他・📎未分類の4つから必ず1つタップします。** 選ばずに保存しようとすると
「カテゴリを選んでください」と出て進めません（未分類にしたいときは「📎未分類」を選べばOKです）。
何もタップしないまま知らないうちに未分類になる、を防ぐための仕様です。

| 項目 | 使いどころ |
|---|---|
| 📷 写真 | **どれを買ってほしいか一目で伝わる**（詰め替え用・型番違い・いつものメーカーなど）。実際に撮る/選ぶ以外に、**🎨「イラストから選ぶ」で用意した20種のイラストを選ぶ**こともできます |
| カテゴリ（必須） | 🍎食品 / 🧻日用品 / 📦その他 → 売り場順に並びます。📎未分類も選べます |
